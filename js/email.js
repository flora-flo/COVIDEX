...
function sendRequest() {
  ...
  try {
    ...
    axios.post("https://serene-crag-69035.herokuapp.com/contact/mailing", {
      name,
      phoneNumber,
      email,
      subject,
...
function check_values() {
  ...
  if (typeof $j("#contactform #phoneNumber").val() != "undefined") {
    body = document.getElementById("phoneNumber").value;
  }
  var errors = 0;
  ...
  if ($j("#contactform #phoneNumber").val() != undefined)
    if ($j("#contactform #phoneNumber").val() == "") {
      var hasClass = $j("#contactform #phoneNumber")
        .parent()
        .find(".error")
        .hasClass("error");
      if (!hasClass)
        $j("#contactform #phoneNumber")
          .parent()
          .append(
            '<label for="contactName" generated="true" class="error">Please enter your phoneNumber</label>'
          );
      $j("#contactform #phoneNumber").focus();
      errors++;
      return false;
    } else $j("#contactform #phoneNumber").parent().find(".error").remove();
